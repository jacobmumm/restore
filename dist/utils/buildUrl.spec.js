...
describe('buildUrl', () => {
    it('returns a basic URL', () => {
        ...
        let url = buildUrl_1.buildUrl(config);
    ...
    it('drops ID param on POST', () => {
        ...
        let url = buildUrl_1.buildUrl(config, source);
        let url2 = buildUrl_1.buildUrl(config2, source2);
    ...
    it('maps object keys using the map param', () => {
        ...
        let url = buildUrl_1.buildUrl(config, source, { id: "longThingId" });
        expect(url).toBe('/thing/2');
    });
});
//# sourceMappingURL=buildUrl.spec.js.map