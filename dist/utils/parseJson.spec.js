...
describe('parseJson', () => {
    it('allows a custom reviver', () => {
        ...
        let data = '{ "p": 5 }';
        let parsed = parseJson_1.parseJson(undefined, reviver, data, undefined);
        expect(parsed.p).toBe(10);
    });
    it('parses JSON', () => {
        let data = '{ "foo": "bar" }';
        let parsed = parseJson_1.parseJson(undefined, undefined, data, undefined);
...
//# sourceMappingURL=parseJson.spec.js.map